...
# Usage: .\run-brick-from-hub.ps1 [port]
#
...
$ContainerName = "dash-gui-brick-$PID"
$Url = "http://localhost:$Port"

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "  DASH-GUI  |  Brick App" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
Write-Host "Starting Brick App..." -ForegroundColor Yellow
docker run -d `
    --rm `
    --name $ContainerName `
    -p "${Port}:${Port}" `
...
Write-Host "  Brick App is running at: $Url" -ForegroundColor Green
...
try {
    ...
    Write-Host ""
    Write-Host "Stopping Brick App..." -ForegroundColor Yellow
